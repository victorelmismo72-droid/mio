...
- ✅ **Albarán con/sin precios y envío por WhatsApp/Email** (29/08/2026): construido y probado. La versión sin precios nunca lleva número de partida (confirmado extrayendo el texto del PDF). Envío por WhatsApp probado con un cliente real de dos teléfonos, envío por email con un cliente real con email guardado — ambos abren el PDF descargado + WhatsApp/correo con el mensaje ya escrito, igual que el HTML actual (no es una integración real, nunca lo fue).
- 🙋 **Impresión física real** (en la impresora que se usa a diario): no se puede probar desde este entorno — hace falta que Víctor lo pruebe él mismo con la pantalla ya construida. Con esto, **el bloque completo de "Etiquetas e impresión" del punto 2 está construido** — solo falta la confirmación física de Víctor (posición exacta en papel, calidad de impresión de las etiquetas térmicas, etc.).
