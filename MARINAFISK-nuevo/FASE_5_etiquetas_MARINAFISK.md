...
- **Ficha de envío / Hoja de ruta / PDF completo de reparto** (`generarPdfFichaEnvio`, `generarPdfHojaDeRutaReparto`, `generarPdfCompletoReparto`) — son documentos de transporte para el reparto, no etiquetas de producto; quedan fuera del alcance de "hacer etiquetas" pedido ahora. Es un candidato razonable para una fase aparte si Víctor lo pide.

Ninguno de estos tres puntos afecta a la trazabilidad ni a la impresión real de etiquetas — son atajos/documentos complementarios alrededor de ellas.
